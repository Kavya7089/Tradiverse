      ...
      <div className="relative h-full flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 flex items-center justify-center min-w-[420px] h-[500px] bg-transparent">
              <Spline scene="https://prod.spline.design/u2zXmXOzqxnFmDVM/scene.splinecode" />
            </div>
          </div>
        </div>
      </div>
